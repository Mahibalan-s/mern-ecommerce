...
const PlaceOrderScreen = () => {
  ...
  const placeOrderHandler = async () => {
    try {
      // We send all the calculated data to the backend
      ...
      // If the backend saves the order, it returns the new Order ID
      // We then navigate to the specific Order Details page
      navigate(`/order/${data._id}`);
      
    } catch (err: any) {
      // If there's an error (e.g., token expired), show it
